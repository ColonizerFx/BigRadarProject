...
@section('title', 'PC Builder - RigRadar')
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-900 overflow-hidden">
                ...
                <div class="px-6 py-5 border-t border-gray-100 bg-gray-50">
                    ...
                    <div class="space-y-3 mt-4">
                        ...
                        <button type="button" @click="checkoutNow()" class="flex items-center justify-center gap-2 w-full bg-brand hover:bg-brand-dark text-white font-bold py-3.5 rounded-full hover-lift transition-all text-sm shadow-md border border-gray-900">
                            Proceed to Checkout
    ...
    function pcBuilder() {
        return {
            ...
            checkoutNow() {
                ...
                const checkoutFlag = document.createElement('input');
                checkoutFlag.type = 'hidden';
                checkoutFlag.name = 'checkout';
                checkoutFlag.value = '1';
                container.appendChild(checkoutFlag);
                document.getElementById('add-build-form').submit();
            }
        }
    }
